...
module.exports = {
	...
	DEV_PLENTY,
	resourcesExpanded: {
		WHEAT: {id: WHEAT, color: "gold"},
		SHEEP: {id: SHEEP, color: "lightgreen"},
		LUMBER: {id: LUMBER, color: "forestgreen"},
		BRICK: {id: BRICK, color: "darkred"},
		ORE: {id: ORE, color: "silver"},
		DESERT: {id: DESERT, color: "tan"},
	},
	devCardDescriptions,
	resourceColorMap,
